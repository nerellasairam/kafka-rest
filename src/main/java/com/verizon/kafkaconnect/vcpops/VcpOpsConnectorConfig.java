...
public class VcpOpsConnectorConfig extends AbstractConfig {
 ...
 // public static final String URL_GROUP_6 = "rest.api.list.6";
  ...
  public VcpOpsConnectorConfig(ConfigDef config, Map<String, String> parsedConfig) {
  ...
  public VcpOpsConnectorConfig(Map<String, String> parsedConfig) {
